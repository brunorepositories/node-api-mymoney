...
export const SELECT_CONTAS = `select array_to_json(array_agg(row_to_json(a))) dados
                              from ( select id, descricao, tipo_conta, saldo from conta where usuario = $1 and ativo = true) a;`
